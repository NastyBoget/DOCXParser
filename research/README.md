...
* [A Machine-Learning Based Approach for Extracting Logical Structure of a Styled Document (2017)](http://itiis.org/digital-library/manuscript/file/21370/TIISVol11No2-23.pdf)
...
* [Extracting Document Structure of a Text with Visual and Textual Cues (2017)](http://essay.utwente.nl/72979/1/Yi%20He%20-%20master%20thesis%20-%20final%20version.pdf)

* [Logical Structure Extraction of Electronic Documents Using Contextual Information (2018)](http://essay.utwente.nl/76427/1/BITEW_MA_EEMCS.pdf)

* [The Financial Document Structure Extraction Shared task: FinToc 2020](https://www.aclweb.org/anthology/2020.fnp-1.2.pdf)


## 2. Обзор по форматам документов
...
|[TEI](https://tei-c.org) [(TEI Lite)](https://tei-c.org/release/doc/tei-p5-exemplars/pdf/tei_lite.doc.pdf)| Для представления семантики и логической структуры документов | XML | Существуют несколько тегов для описания визуальных особенностей текста | Создан для отображения логической структуры | Обширный список различных [инструментов](https://wiki.tei-c.org/index.php/Category:Tools) для работы с форматом | Содержит обширный набор тегов | Есть инструменты для визуализации, формат читаем |
|[ODA](https://www.itu.int/rec/T-REC-T.411-199303-I/en)| Для описания структурированных данных объектного типа | - | Поддерживается | Поддерживается | Из-за сложности стандарта существует мало инструментов для работы с форматом, формат устарел | Огромный и сложный стандарт | Сложно читать, инструментов визуализации мало |
|[Office Open XML](http://www.ecma-international.org/publications/files/ECMA-ST/ECMA-376,%20Fifth%20Edition,%20Part%201%20-%20Fundamentals%20And%20Markup%20Language%20Reference.zip)|Для хранения электронных документов пакетов офисных приложений | zip-архив, содержащий текст в виде XML, графику и другие данные| Обширные возможности для описания физической структуры | Практически нет | Есть приложения и библиотеки для работы, однако полностью обработать документ сложно | Очень большая документация | Читаемо в приложениях, в xml структура сложная |
|[reStructuredText](https://docutils.sourceforge.io/rst.html)| Для создания простых веб-страниц и других документов, комментариев в программном коде | Structured Text and Setext | Ограничена, но разнообразнее, чем Markdown | Ограничена, но разнообразнее, чем Markdown | Есть | Небольшой стандарт, относительно простой формат | Читаемый, можно визуализировать |
|[Markdown](https://daringfireball.net/projects/markdown/)| Облегчённый язык разметки для обозначения форматирования в простом тексте | Text E-mail conventions | Поддерживается, но ограниченно | Поддерживается в очень ограниченном количестве | Есть инструменты для работы | Простой и интуитивно понятный | Читаемый, хорошо визуализируется в браузерах |
|[JSON](http://json.org/json-ru.html)| Для сериализации сложных структур, в веб-приложениях - для обмена данными | Расширен из JavaScript | Существует возможность описания | Есть | Обширная программная поддержка | Простой в освоении формат | Не очень удобен для чтения |
|[YAML](https://yaml.org/spec/current.html#id2438200)| Язык разметки, удобный для представления структур данных в различных ЯП | Расширен из XML, Perl и JSON | Существует возможность описания | Есть | Библиотеки для большого числа наиболее популярных ЯП | Относительно несложный | Читаемый |
...
\+ одновременное представление как логической, так и физической структуры документа
...
* [YAML](https://yaml.org/spec/current.html#id2438200)
    ...
    YAML можно рассматривать как "расширенный JSON". 
